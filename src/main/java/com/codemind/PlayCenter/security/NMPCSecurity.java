...
public class NMPCSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(configurer ->
                        ...
                        configurer
                                .requestMatchers("/nmpc-home", "/loginPage", "/explore/**", "/contact/**", "/images/**", "/css/**", "/js/**","/register/**","/forgot/**","/pdfs/**","/teacher/**").permitAll() // Allow access to static resources
                                .requestMatchers("/dashboard/show-user").hasRole("ADMIN")
                                .requestMatchers("/dashboard/fill-attendance").hasRole("TEACHER")
